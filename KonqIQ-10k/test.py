...
def eval(checkpoint, test_file, test_file_path, save_file, idx=1):
    ...
    model.load_state_dict(torch.load('{}/{}/checkpoint/DataParallel-00007.pt'.format(checkpoint, idx))['state_dict'])
...
if __name__ == '__main__':
    for idx in range(1, 11):
        test_file = 'koniq10k_splits2/{}/koniq10k_test.txt'.format(idx)
        test_file_path = '/home/zhihua/IQA_database/koniq-10k/'
        save_file = 'preds_mask/kadid10k_test_split{}.txt'.format(idx)
        checkpoint = 'balanced_0.7_woa'
        save_path = os.path.join(checkpoint, 'preds_mask')
