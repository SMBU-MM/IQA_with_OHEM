...
def parse_config():
    ...
    checkpoint_path = r"./fixedmask_0.7_woa/"
    parser.add_argument('--ckpt', default=checkpoint_path, type=str, help='name of the checkpoint to load')
    
    parser.add_argument("--train_txt", type=str, default='koniq10k_train.txt') # train.txt | train_synthetic.txt | train_authentic.txt | train_sub2.txt | train_score.txt
...
if __name__ == "__main__":
    for i in range(4,11):
        ...
        config.kadid_LT = 'koniq10k_splits2'
        main(config)
